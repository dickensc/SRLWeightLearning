 for j in Ranking Discrete; do
   ./bowlSS_learn.sh Epinions.psl Epinions-learn-${1}.data ${2} ${j} Epinions;
 ...
 for j in Categorical Discrete; do
   ./bowlSS_learn.sh Citeseer.psl Citeseer-learn-${1}.data ${2} ${j} Citeseer;
 ...
 for j in Categorical Discrete; do
   ./bowlSS_learn.sh Cora.psl Cora-learn-${1}.data ${2} ${j} Cora;
...
then
  for j in Continuous Ranking; do
    ./bowlSS_learn.sh LastFM.psl LastFM-learn-${1}.data ${2} ${j} LastFM;
 ...
 for j in Continuous Ranking; do
   ./bowlSS_learn.sh Jester.psl Jester-learn-${1}.data ${2} ${j} Jester;
