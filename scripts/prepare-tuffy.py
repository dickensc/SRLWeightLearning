...
"""
This file contains methods for converting psl formatted data into tuffy formatted data.
"""
...
DATA = 'data'
# file name for the predicate information needed to translate from PSL to tuffy
...
def load_split(predicate, split):
    ...
    # tuffy_data is an array of tuffy formatted evidence
    # predicate_data is an array of tuffy formatted queries
    tuffy_data = []
    predicate_data = []
...
def main(tuffy_dir, psl_dir, experiment):
    ...
    # save experiment paths for tuffy and psl
    tuffy_experiment_path = os.path.join(tuffy_dir, experiment)
    psl_experiment_path = os.path.join(psl_dir, experiment)

    predicate_properties = load_predicate_properties(os.path.join(tuffy_experiment_path, PREDICATES_FILE))
...
if __name__ == '__main__':
    tuffy_directory, psl_directory, experiment_name = _load_args(sys.argv)
    main(tuffy_directory, psl_directory, experiment_name)
