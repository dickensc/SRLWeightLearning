...
#define FULLYBOUNDEDSIMPLEX _FALSE     /* WARNING: Activate at your own risk! */
...
#define DEF_TIMEDREFACT  AUTOMATIC  /* Default for timed refactorization in BFPs;
                                       can be _FALSE, TRUE or AUTOMATIC (dynamic) */
...
struct _lprec
{
  ...
  _hashtable *rowname_hashtab;   /* hash table to store row names */
  _hashtable *colname_hashtab;   /* hash table to store column names */
  ...
  MYBOOL    *is_lower;          /*  "       " : TRUE if the variable is at its
                                   lower bound (or in the basis), _FALSE otherwise */
